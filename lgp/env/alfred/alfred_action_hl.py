...
class AlfredActionHL(Subgoal, Task):
    """This is similar to AlfredAction, but the argument_mask is an allocentric
    voxel grid."""
    ...
    def to(self, device):
        ...
        self.argument_vector = (
            ...
            if self.argument_vector is not None
            else None
        )
        return self
    ...
    def __eq__(self, other: "AlfredActionHL"):
        ...
        return self.action_type == other.action_type and (
            ...
            or (self.argument_mask == other.argument_mask).all()
        )
