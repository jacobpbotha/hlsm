...
NAV_ACTION_TYPES = ["RotateLeft", "RotateRight", "MoveAhead", "LookUp", "LookDown"]
...
class AlfredAction(Action):
    def __init__(self, action_type: str, argument_mask: torch.tensor):
        super().__init__()
    ...
    def __eq__(self, other: "AlfredAction"):
        return (
            ...
            and self.argument_mask == other.argument_mask
        )
