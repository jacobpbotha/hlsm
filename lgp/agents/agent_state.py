...
class AgentState:
    """The full "state" of the agent. When starting a new task / rollout,
    clearing this state is sufficient to completely reset the agent and make
    sure there is no residual state.
