...
from lgp.models.alfred.projection.pointcloud_voxelgrid_intersection import \
    PointcloudVoxelgridIntersection
...
class VoxelMaskToImageMask(nn.Module):
    ...
    def forward(
        ...
        if DISTR and isinstance(depth_image, DepthEstimate):
            ...
            point_masks = [
                self.pointcloud_voxel_intersection(pc, voxel_grid)
                for pc in all_img_point_coords
            ]
